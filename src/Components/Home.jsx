...
const Home = ({setCurrentPage}) => {
    ...
    const toggleVisibility = () => {
        ...
        const duration = TOGGLE_EYE_SPEED;
    ...
    return (
        <section>
            ...
            >
                ...
                {/* W in the chat covid skibidi toilet*/}
                {/*<div className="md:w-1/3 max-w-sm lg:mr-auto lg:ml-auto">*/}
                {/*    <img*/}
                {/*        src={lightHome}*/}
                {/*        alt="Home Image"*/}
                {/*    />*/}
            ...
            <div
                ...
                data-aos="fade-up"
            >
                <section className={`bg-opacity-70 p-10 md:p-20 rounded-2xl w-full max-w-md mx-auto ${
                    isDarkMode
                        ? "bg-gray-600"
                        : "bg-gray-300"
                }`}>
